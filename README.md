...
8.[1주차 작업 결과](#1주차-작업-결과)  
8.[2주차 작업 결과](#2주차-작업-결과)  
8.[3주차 작업 결과](#3주차-작업-결과)  
8.[4주차 작업 결과](#4주차-작업-결과)  
8.[5주차 작업 결과](#5주차-작업-결과)  
8.[6주차 작업 결과](#6주차-작업-결과)
# [게임명: 너구리fly]
...
|item_Speed|이동속도 0.5 공격속도 0.02씩 오름 score +300|먹으면 라이프 갯수가 올라감 맥스라이프일때 먹을경우 스코어점수 300이 올라감|
### 4)오브젝트 이름: Item_Boom
